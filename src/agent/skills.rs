...
const INTENT_RULES: &[IntentRule] = &[
    ...
    // ── how-to-illustrate: MANDATORY router for any draw/illustrate/diagram/
    // chart/graph/visualize/map request. Fires before the excalidraw-specific
    // rule so generic drawing intent always routes through the full taxonomy +
    // tool picker + interactivity mandate first.
    IntentRule {
        skill_names: &["how-to-illustrate"],
        phrases: &[
            "how-to-illustrate",
            "draw a diagram",
        ...
        label: "how-to-illustrate",
        why: "comprehensive diagram-type + tool router (excalidraw/tldraw/penecho) with interactivity mandate",
    },
    IntentRule {
    ...
    IntentRule {
        ...
        label: "skeuomorphic-ui",
        why: "dark skeuomorphic UI (top-lit, layered shadows, tactile depth)",
    },
    IntentRule {
        skill_names: &["akarso"],
        phrases: &[
        ...
        label: "akarso",
        why: "post/schedule across social platforms (akarso tool)",
    },
    IntentRule {
        skill_names: &["openseo"],
        phrases: &[
        ...
        label: "openseo",
        why: "SEO research/audits via OpenSEO MCP",
    },
    IntentRule {
        skill_names: &["dialkit"],
        phrases: &[
        ...
        label: "dialkit",
        why: "live tuning of interface parameters (dialkit)",
    },
    IntentRule {
        skill_names: &["gateway-cache-awareness"],
        phrases: &[
