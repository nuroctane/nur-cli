...
Full `$` table: `hunting-x-linked-bounties` `references/paid-payouts.md`. Harvest / Mango / Bonq are **hack** analogs (`case-cards.md`).

| $ | Protocol | Pack | Whitehat |
|---|----------|------|----------|
| $800k | Fei flashloan composition | T05 / T09 | Bobface |
| $19k | Enzyme oracle (same protocol as $400k privilege) | T05 | setuid0 |
