...
2. Optional: `references/grep-patterns.md` then `references/bug-classes.md` to pick a class.
...
| `references/bug-classes.md` | 20 DeFi classes |
...
3. Solodit + SWC + bug-classes on every review.
